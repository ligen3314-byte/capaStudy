...
SERVICE_XLSX = Path(__file__).resolve().parent / "msc_service_start_end.xlsx"
SERVICE_XLSX_FALLBACK = Path(__file__).resolve().parent / "msc_service_start_end_filled.xlsx"
