...
LEGACY_MERGED_DIR = PROJECT_ROOT / "merged_query"
...
# Carrier query outputs
CSL_QUERY_DIR = CSL_DIR / "csl_query"
MSC_QUERY_DIR = MSC_DIR / "msc_query"
MSK_QUERY_DIR = MSK_DIR / "msk_query"
...
CSL_ARTIFACT_DIR = CSL_DIR / "artifacts"
